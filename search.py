...
def uniformCostSearch(problem):
    ...
    return GraphSearch(problem, util.PriorityQueueWithFunction(lambda state: state[2])) #state[2] is the cumulative cost
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    return GraphSearch(problem, util.PriorityQueueWithFunction( lambda state: state[2] + heuristic(state[0],problem) ) )
